...
// Generated from districtinformation.xlsx
// Contains location data for 12 Eastern Uganda districts

class LocationData {
  // District codes for user ID generation
  static const Map<String, String> districtCodes = {
    'BUGIRI': 'BUG',
    'BUGWERI': 'BWE',
    'BUYENDE': 'BUY',
    'IGANGA': 'IGA',
  ...
  // Get district code from full name
  static String getDistrictCode(String districtName) {
    return districtCodes[districtName.toUpperCase()] ?? 'UGA';
  }
  ...
  static List<String> getSubcounties(String district) {
    return _subcountyData[district]?.keys.toList() ?? [];
  }
  ...
  // Subcounty data
  static const Map<String, Map<String, bool>> _subcountyData = {
    'BUGIRI': {
      'BUDHAYA': true,
      'BULESA': true,
      'BULIDHA': true,
      'BULUGUYI': true,
      'BUSOWA TOWN COUNCIL': true,
      'BUWUNGA': true,
      'BUWUNI TOWN COUNCIL': true,
      'EASTERN DIVISION': true,
      'IWEMBA': true,
      'KAPYANGA': true,
      'MAYUGE TOWN COUNCIL': true,
      'MUTELELE TOWN COUNCIL': true,
      'MUTERERE': true,
      'MUWAYO TOWN COUNCIL': true,
      'NABUKALU': true,
      'NABUKALU TOWN COUNCIL': true,
      'NAMAYEMBA TOWN COUNCIL': true,
      'NANKOMA': true,
      'NANKOMA TOWN COUNCIL': true,
      'WESTERN DIVISION': true,
    },
    'BUGWERI': {
      'BUSEMBATIA TOWN COUNCIL': true,
      'BUSESA TOWN COUNCIL': true,
      'BUYANGA': true,
      'IBULANKU': true,
      'IDUDI TOWN COUNCIL': true,
      'IGOMBE': true,
      'MAKUUTU': true,
      'NAMALEMBA': true,
    },
    'BUYENDE': {
      'BUGAYA': true,
      'BUKUNGU TOWN COUNCIL': true,
      'BUYANJA': true,
      'BUYENDE': true,
      'BUYENDE TOWN COUNCIL': true,
      'GUMPI': true,
      'IRUNDU': true,
      'IRUNDU TOWN COUNCIL': true,
      'KAGULU': true,
      'KIDERA': true,
      'KIDERA TOWN COUNCIL': true,
      'NDOLWA': true,
      'NGANDHO': true,
      'NKONDO': true,
    },
    'IGANGA': {
      ...
      'NAKIGO': true,
      'NAMBALE': true,
      'NAMUNGALWE TOWN COUNCIL': true,
      'NAWANDALA': true,
      'NAWANYINGI': true,
      'NORTHERN DIVISION': true,
    },
    'JINJA': {
      'BUSEDDE': true,
      'BUTAGAYA': true,
      'BUWENGE': true,
      'BUWENGE TOWN COUNCIL': true,
      'BUYENGO TOWN COUNCIL': true,
    ...
    'KALIRO': {
      'BUDOMERO': true,
      'BUKAMBA': true,
      'BULUMBA TOWN COUNCIL': true,
      'BUMANYA': true,
      'BUYINDA': true,
      'GADUMIRE': true,
      'KALIRO TOWN COUNCIL': true,
      'KASOKWE': true,
      'KISINDA': true,
      'NAMUGONGO': true,
      'NAMWIWA': true,
      'NAMWIWA TOWN COUNCIL': true,
      'NANSOLOLO': true,
      'NAWAIKOKE': true,
      'NAWAIKOKE TOWN COUNCIL': true,
    },
    'KAMULI': {
      'BALAWOLI': true,
      'BALAWOLI TOWN COUNCIL': true,
      'BUGULUMBYA': true,
      'BULOPA': true,
      'BUTANSI': true,
      'KAGUMBA': true,
      'KASAMBIRA TOWN COUNCIL': true,
      'KISOZI': true,
      'KISOZI TOWN COUNCIL': true,
      'KITAYUNJWA': true,
      'MAGOGO': true,
      'MBULAMUTI': true,
      'MBULAMUTI TOWN COUNCIL': true,
      'NABWIGULU': true,
      'NAMASAGALI': true,
      'NAMWENDWA': true,
      'NAMWENDWA TOWN COUNCIL': true,
      'NAWANYAGO': true,
      'NAWANYAGO TOWN COUNCIL': true,
      'NORTHERN DIVISION': true,
      'SOUTHERN DIVISION': true,
      'WANKOLE': true,
    },
    'LUUKA': {
      'BUKANGA': true,
      'BUKOOMA': true,
      'BUKOOVA TOWN COUNCIL': true,
      'BULANGA TOWN COUNCIL': true,
      'BULONGO': true,
      'BUSALAMU TOWN COUNCIL': true,
      'IKUMBYA': true,
      'IRONGO': true,
      'KYANVUMA TOWN COUNCIL': true,
      'LUUKA TOWN COUNCIL': true,
      'NAWAMPITI': true,
      'WAIBUGA': true,
    },
    'MAYUGE': {
      'BAITAMBOGWE': true,
      'BUGADDE TOWN COUNCIL': true,
      'BUKABOOLI': true,
      'BUKATUBE': true,
      'BUSAKIRA': true,
      'BUWAAYA': true,
      'BWONDHA TOWN COUNCIL': true,
      'IMANYIRO': true,
      'JAGUZI': true,
      'KIGANDALO': true,
      'KITYERERA': true,
      'MAGAMAGA TOWN COUNCIL': true,
      'MALONGO': true,
      'MAYUGE TOWN COUNCIL': true,
      'MPUNGWE': true,
      'WAIRASA': true,
    ...
    'NAMAYINGO': {
      ...
      'LOLWE': true,
      'MUTUMBA': true,
      'MUTUMBA TOWN COUNCIL': true,
      'NAMAYINGO TOWN COUNCIL': true,
      'SIGULU ISLANDS': true,
    },
    'NAMUTUMBA': {
      'BUGOBI': true,
      'BUGOBI TOWN COUNCIL': true,
      'BULANGE': true,
      'IVUKULA': true,
      'IVUKULA TOWN COUNCIL': true,
      'KAGULU': true,
      'KIBAALE': true,
      'KIBALE TOWN COUNCIL': true,
      'KIWANYI': true,
      'KIZUBA': true,
      'MAGADA': true,
      'MAZUBA': true,
      'NABWEYO': true,
      'NAMUTUMBA': true,
      'NAMUTUMBA TOWN COUNCIL': true,
      'NANGONDE': true,
      'NANGONDE TOWN COUNCIL': true,
      'NAWAIKONA': true,
      'NSINZE': true,
      'NSINZE TOWN COUNCIL': true,
    },
  };
  ...
  static const Map<String, Map<String, Map<String, bool>>> _parishData = {
    'BUGIRI': {
      ...
      'BUSOWA TOWN COUNCIL': {
        ...
        'NABIKAKA WARD': true,
        'NAKAWA WARD': true,
        'NAKIDUDULA WARD': true,
        'NAWANDHUKI WARD': true,
      },
      'BUWUNGA': {
        'BUBUGO': true,
        'BUPALA': true,
      ...
      'BUWUNI TOWN COUNCIL': {
        'BUWUNI RURAL WARD': true,
        'BUWUNI WARD': true,
        'KASEBERE WARD': true,
        'MAKHOMA NORTH WARD': true,
        'MAKHOMA SOUTH WARD': true,
        'NAINALA WARD': true,
      ...
      'NANKOMA TOWN COUNCIL': {
        'ITAKAIBOLU WARD': true,
        'MASITA WARD': true,
        'NAKASITA WARD': true,
        'NAMUNTENGA WARD': true,
        'NANKOMA CENTRAL WARD': true,
    ...
    'BUGWERI': {
      'BUSEMBATIA TOWN COUNCIL': {
        'BUSEMBATIA CENTRAL WARD': true,
        'BUSEMBATIA MARKET WARD': true,
        'BUYIRIMA WARD': true,
        'KAKOGE WARD': true,
        'MAJENGO WARD': true,
      },
    ...
    'IGANGA': {
      ...
      'CENTRAL DIVISION': {
        'BULIGO WARD': true,
        'KASOKOSO WARD': true,
        'NABIDONGHA PRISON WARD': true,
        'NABIDONGHA WARD': true,
        'NAKAVULE WARD': true,
        'WALUGOGO WARD': true,
      },
      'KIDAAGO': {
      ...
      'NAMUNGALWE TOWN COUNCIL': {
        ...
        'NAMUNGALWE WARD': true,
        'NAMUNKANAGA WARD': true,
        'NAMUNKESU WARD': true,
        'NAMUNSAALA WARD': true,
        'NAWANSEGA WARD': true,
      },
      'NAWANDALA': {
        'BUGONGO': true,
    ...
    'JINJA CITY': {
      'JINJA NORTH DIVISION': {
        'BUDHUMBULI EAST WARD': true,
        'BUDHUMBULI WEST WARD': true,
        'BUWAGI (KAKYOMYA) WARD': true,
        'BUWEKULA WARD': true,
        'BUWENDA TC WARD': true,
        'IVUNAMBA WARD': true,
        'KATENDE WARD': true,
        'KIBIBI WARD': true,
        'MAFUBIRA WARD': true,
        'NAKANYONYI WARD': true,
        'NAMIZI WARD': true,
        'NAMULESA WARD': true,
        'NAWANGOMA WARD': true,
        'WANYAMA WARD': true,
      ...
      'JINJA SOUTH DIVISION': {
        'CENTRAL JINJA EAST WARD': true,
        'CENTRAL JINJA WEST WARD': true,
        'KIMAKA WARD': true,
        'LUBAGA WARD': true,
        'MAGGWA WARD': true,
        'MASESE WARD': true,
        ...
        'NALUFENYA WARD': true,
        'OLD BOMA WARD': true,
        'WALUKUBA EAST WARD': true,
        'WALUKUBA WEST WARD': true,
      },
    },
    'KALIRO': {
      'BUDOMERO': {
    ...
    'KAMULI': {
      ...
      'NAWANYAGO TOWN COUNCIL': {
        ...
        'NAWANYAGO EAST WARD': true,
        'NAWANYAGO WEST WARD': true,
      },
      'NORTHERN DIVISION': {
        'BUWANUME WARD': true,
        'KAMULI-SABAWALI WARD': true,
        'KASOIGO WARD': true,
        'MUWEBWA WARD': true,
        'NAMISAMBYA II WARD': true,
      },
      'SOUTHERN DIVISION': {
        'BUSOTA WARD': true,
        'KAMULI-NAMWENDA WARD': true,
        'MANDWA WARD': true,
        'MULAMBA WARD': true,
        'NAKULYAKU WARD': true,
      },
    ...
    'LUUKA': {
      ...
      'BUKOOVA TOWN COUNCIL': {
        'BUKANHA WARD': true,
        'BUKOOVA CENTRAL WARD': true,
        'BUKOOVA RURAL WARD': true,
        'BUNABALA WARD': true,
        'BUSANDA WARD': true,
        'BUTASERWA WARD': true,
        'BUYOGA WARD': true,
      ...
      'BUSALAMU TOWN COUNCIL': {
        'BUSALAMU EAST WARD': true,
        'BUSALAMU NORTH WARD': true,
        'BUSALAMU SOUTH WARD': true,
        'BUSALAMU WEST WARD': true,
      },
      'IKUMBYA': {
        'BUNAFU': true,
        'IKUMBYA': true,
      ...
      'KYANVUMA TOWN COUNCIL': {
        ...
        'MAGADA WARD': true,
        'NAKABAALE WARD': true,
        'NAKABAMBWE WARD': true,
        'NSIMAKATONO WARD': true,
      },
      'LUUKA TOWN COUNCIL': {
        'BUSIMAWU WARD': true,
        'BUSONGA WARD': true,
        'KITWEKYAMBOGO WARD': true,
        'KIYUNGA WARD': true,
        'LWADA WARD': true,
      },
      'NAWAMPITI': {
    ...
    'MAYUGE': {
      ...
      'BWONDHA TOWN COUNCIL': {
        'BWONDHA CENTRAL WARD': true,
        'BWONDHA SOUTH WARD': true,
        'MAKONKO WARD': true,
        'MUSOMA WARD': true,
        'NALUBABWE WARD': true,
        'NKALANGA WARD': true,
    ...
    'NAMAYINGO': {
      ...
      'MUTUMBA TOWN COUNCIL': {
        ...
        'LUBIRA WARD': true,
        'MAWA WARD': true,
        'MUTUMBA NORTH WARD': true,
        'MUTUMBA SOUTH WARD': true,
      },
      'NAMAYINGO TOWN COUNCIL': {
        'BUDIDI WARD': true,
        'BULAMBA WARD': true,
        'NAMAYINGO CENTRAL WARD': true,
        'NAMBUGU WARD': true,
        'NASINU WARD': true,
      },
      'SIGULU ISLANDS': {
    ...
    'NAMUTUMBA': {
      ...
      'BUGOBI TOWN COUNCIL': {
        'BUGOBI B WARD': true,
        'BUGOBI CENTRAL WARD': true,
        'BUGOBI EAST WARD': true,
        'BUKENGA WARD': true,
        'KIBIGO WARD': true,
        'TOWN SIDE WARD': true,
      },
      ...
      'NAMUTUMBA TOWN COUNCIL': {
        'NAMUTUMBA CENTRAL WARD': true,
        'NAMUTUMBA NORTH WARD': true,
        'NAMUTUMBA SOUTH WARD': true,
      },
      'NANGONDE': {
        'BUWALIRA': true,
        'IWUNGIRO': true,
      ...
      'NANGONDE TOWN COUNCIL': {
        ...
        'IWUNGIRO WARD': true,
        'KIGUNDA WARD': true,
        'KITAIGALWA WARD': true,
        'NANGONDE CENTRAL WARD': true,
        'NANGONDE WARD': true,
        'NAWANDAKA WARD': true,
      },
      'NAWAIKONA': {
  ...
  _villageData = {
    ...
    'BUYENDE': {
      ...
      'BUYENDE': {
        ...
        'KIRIBAIRYA': [
          ...
          'KIBYASI',
          'KIRIBAIRYA A',
          'KIRIBAIRYA CENTRAL A',
          'KIRIBAIRYA CENTRAL B',
          'KIRIBAIRYA LANDING',
          'KIRIBAIRYA T/CENTRE',
          'WAIRUGALA',
        ],
    ...
    'JINJA CITY': {
      'JINJA NORTH DIVISION': {
        ...
        'NAMIZI WARD': [
          ...
          'BUYALA B',
          'BUYALA C',
          'BUYALA TRADING CENTRE',
          'KABOWA KAMPALA',
          'KABOWA TRADING CENTRE',
          'NAMIZI CENTRAL',
          'NAMIZI EAST',
          'NAMIZI WEST',
        ],
    ...
    'NAMUTUMBA': {
      ...
      'NANGONDE TOWN COUNCIL': {
        ...
        'NANGONDE CENTRAL WARD': [
          'NANGONDE CENTRAL ZONE',
          'NANGONDE ZONE A',
          'NANGONDE ZONE B',
        ],
        'NANGONDE WARD': [
