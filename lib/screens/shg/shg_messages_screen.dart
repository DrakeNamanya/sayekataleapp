...
class SHGMessagesScreen extends StatefulWidget {
  const SHGMessagesScreen({super.key});

  @override
  State<SHGMessagesScreen> createState() => _SHGMessagesScreenState();
}

class _SHGMessagesScreenState extends State<SHGMessagesScreen> {
