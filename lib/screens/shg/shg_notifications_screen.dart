...
class SHGNotificationsScreen extends StatefulWidget {
  const SHGNotificationsScreen({super.key});

  @override
  State<SHGNotificationsScreen> createState() => _SHGNotificationsScreenState();
}

class _SHGNotificationsScreenState extends State<SHGNotificationsScreen> {
