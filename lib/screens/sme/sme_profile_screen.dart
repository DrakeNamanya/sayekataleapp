                    ...
                    onTap: () async {
                      ...
                      if (confirmed == true && context.mounted) {
                        ...
                        try {
                          ...
                          if (kDebugMode) {
                            debugPrint('⏳ SME PROFILE - Waiting for AuthProvider to clear user...');
                          }
                          ...
                          while (authProvider.isAuthenticated && attempts < 10) {
                            ...
                            if (kDebugMode) {
                              debugPrint(
                                '⏳ SME PROFILE - Attempt $attempts: isAuthenticated = ${authProvider.isAuthenticated}',
                              );
                            }
                          }
                          ...
                          if (kDebugMode) {
                            debugPrint(
                              '✅ SME PROFILE - AuthProvider cleared user: isAuthenticated = ${authProvider.isAuthenticated}',
                            );
                          }
