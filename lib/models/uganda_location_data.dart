...
class UgandaLocationData {
  ...
  static final Map<String, Map<String, Map<String, List<String>>>>
  _locationData = {
    'BUGIRI': {
      'BUDHAYA': {
        'BUDHAYA': [
  ...
  static bool isValidLocation({
    ...
    if (subcounty != null) {
      ...
      if (parish != null) {
        ...
        if (village != null) {
          if (!_locationData[district]![subcounty]![parish]!.contains(
            village,
          )) {
            return false;
          }
  ...
  static Map<String, dynamic> getDistrictData(String district) {
    ...
    _locationData[district]!.forEach((subcounty, parishes) {
      Map<String, dynamic> subcountyInfo = {'name': subcounty, 'parishes': []};

      parishes.forEach((parish, villages) {
        subcountyInfo['parishes'].add({'name': parish, 'villages': villages});
      });
